...
//@Component
//public class JMSReceiverAcknwldgment implements ChannelAwareMessageListener {
//
//	// using logger slf4j
//	private static final Logger log = LoggerFactory.getLogger(JMSReceiverAcknwldgment.class);
//
//	@Override
